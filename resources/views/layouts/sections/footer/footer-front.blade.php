      ...
      <div class="row gx-0 gy-6 g-lg-10">
        <div class="col-lg-5">
          ...
          <p class="footer-text footer-logo-description mb-6">
            Platform manajemen pesantren yang modern, fleksibel, dan siap digunakan — dirancang untuk membantu pesantren
            mengelola absensi dan aktivitas santri dengan lebih mudah.
          </p>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
          <h6 class="footer-title mb-6">Fitur & Layanan</h6>
          <ul class="list-unstyled">
            <li class="mb-4">
              <a href="/demo-1" target="_blank" class="footer-link">Dashboard</a>
            </li>
            <li class="mb-4">
              <a href="/demo-5" target="_blank" class="footer-link">Fitur Absensi</a>
            </li>
            <li class="mb-4">
              <a href="/demo-2" target="_blank" class="footer-link">Fitur Premium</a>
            </li>
            <li class="mb-4">
              <a href="/demo-3" target="_blank" class="footer-link">Pricing</a>
            </li>
            <li class="mb-4">
              <a href="/demo-4" target="_blank" class="footer-link">Help Center</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6">
          ...
          <ul class="list-unstyled">
            <li class="mb-4">
              <a href="{{ url('/front-pages/pricing') }}" class="footer-link">
                Tentang SantriNexus
              </a>
            </li>
            <li class="mb-4">
              <a href="{{ url('/front-pages/payment') }}" class="footer-link">
                Panduan Pengguna
              </a>
            </li>
            <li class="mb-4">
              <a href="{{ url('/front-pages/checkout') }}" class="footer-link">Kemitraan
                <span class="badge bg-primary ms-2">Baru</span></a>
            </li>
            <li class="mb-4">
              <a href="{{ url('/front-pages/help-center') }}" class="footer-link">Kartu RFID/QR</a>
            </li>
            <li class="mb-4">
        ...
        <div class="col-lg-3 col-md-4">
          <h6 class="footer-title mb-6">Unduh Aplikasi (Coming Soon)</h6>
  ...
  <div class="footer-bottom py-3 py-md-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      <div class="mb-2 mb-md-0">
        ...
        <span class="footer-bottom-text">Untuk memajukan digitalisasi pesantren di Indonesia.</span>
      </div>
      <div>
